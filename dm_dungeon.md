...
In story, rooms are described by what they are. See dm_narration.md → Tone and
...
| Status | Meaning |
|---|---|
| `untouched` | Room exists in manifest, no file yet, player hasn't approached |
...
3. Migrate significant NPCs that may appear elsewhere to
   {Game Name} Rules/campaign/world-log.md → persistent_npcs.
4. Generate the new location's layout.md and session-log.md as in the
   Setup Phase (see dm_setup.md).
